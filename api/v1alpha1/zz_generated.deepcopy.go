...
func (in *ContainerOptions) DeepCopyInto(out *ContainerOptions) {
	*out = *in
	...
	if in.PyxisAPITokenSecretRef != nil {
		in, out := &in.PyxisAPITokenSecretRef, &out.PyxisAPITokenSecretRef
		*out = new(string)
		**out = **in
	}
}
...
func (in *PreflightCheckSpec) DeepCopyInto(out *PreflightCheckSpec) {
	*out = *in
	...
	if in.DockerConfigSecretRef != nil {
		in, out := &in.DockerConfigSecretRef, &out.DockerConfigSecretRef
		*out = new(string)
		**out = **in
	}
